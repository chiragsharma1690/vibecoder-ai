        ...
        <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          {isConnected && workspaceInfo && (
            <div className="flex items-center gap-4 animate-fade-in">
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-medium text-zinc-400 shadow-sm">
              ...
              {/* 👈 NEW BACK / DISCONNECT BUTTON */}
              <button 
                onClick={onDisconnect}
                className="p-1.5 text-zinc-500 hover:text-red-400 hover:bg-red-500/10 rounded-md transition-colors border border-transparent hover:border-red-500/20"
